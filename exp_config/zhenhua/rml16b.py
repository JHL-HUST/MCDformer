import os, sys
# os.environ["CUDA_VISIBLE_DEVICES"] = "0,4,1"
...
from models._baseSetting import AMC_Net_base, AWN_base, mcldnn_base, vtcnn2_base, dualnet_base,CTDNN,MCDformer_base
class Data(TaskDataset):
    ...
    def rawdata_config(self) -> object:
        ...
        self.post_data_file = 'Dataset/RML2016.10b/RML2016.10b_dict.split.pt'
        
    def load_rawdata(self, logger = None):
        file_pointer = 'Dataset/RML2016.10b/RML2016.10b.dat'
...
class amcnet(AMC_Net_base):
    def task_modify(self):
        ...
        self.hyper.pretraining_file = 'pretraining_models/pretrain_models_16b/2016.10b_AMC_Net_offical_pre.pkl'
...
class awn(AWN_base):
    def task_modify(self):
        ...
        self.hyper.pretraining_file = 'pretraining_models/pretrain_models_16b/RML2016.10b_AWN.best.pt'
...
class vtcnn(vtcnn2_base):
    def task_modify(self):
        ...
        self.hyper.pretraining_file = 'pretraining_models/pretrain_models_16b/RML2016.10b_vtcnn.best.pt'
        # self.tuner.resource = {
        #     "cpu": 5,
        #     "gpu": 0.5  # set this for GPUs
        # }
...
class dualnet(dualnet_base):
    def task_modify(self):
        ...
        self.hyper.pretraining_file = 'pretraining_models/pretrain_models_16b/RML2016.10b_dualnet.best.pt'

class mcl(mcldnn_base):
    def task_modify(self):
        self.hyper.epochs = 100
        self.hyper.pretraining_file = 'pretraining_models/pretrain_models_16b/RML2016.10b_mcl.best.pt'
...
class ctdnn(CTDNN):
    def ablation_modify(self):
        self.hyper.epochs = 100
        self.hyper.pretraining_file = 'OpenAMC-dev/exp_tempTest/RML2016.10b/train_last.ctdnn/fit/ctdnn/checkpoint/RML2016.10b_ctdnn.best.pt'
        self.hyper.num_heads = 2
        self.hyper.gamma = 0.5
...
class cldnn(cldnn_base):
    def ablation_modify(self):
        self.hyper.pretraining_file = 'pretraining_models/pretrain_models_16b/RML2016.10b_cldnn.best.pt'
...
if __name__ == "__main__":
    ...
    args.exp_name = f'train_{model_name}' # tuning.infv3
    # args.exp_name = f'complexity_{model_name}' # tuning.infv3
    args.gid = 3
    
    args.test = True
    args.clean = True
    args.model = model_name #MCDformer dualnet
